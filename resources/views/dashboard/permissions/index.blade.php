            ...
            <div class="card border-0">
                <div class="card-header row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <h3 class="m-0 text-center text-lg-start">Permissions</h3>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="text-center text-lg-end">
                            @can('Permission create')
                            <a href="{{route('permissions.create')}}" class="btn btn-success" type="button"><i class="fa-solid fa-plus"></i> Add</a>
                            @endcan
                        </div>
                    </div>
                </div>
                            ...
                            <tr class="border-bottom-secondary">
                                ...
                                <td>
                                    <ul class="action d-flex align-items-center list-unstyled m-0 justify-content-center">
                                        <li class="edit"> <a href="{{ route('permissions.edit', $item->id) }}">
                                                <i class="fa-solid fa-pen-to-square fs-5 text-danger"></i></a></li>
                                        <form action="{{route('permissions.destroy', $item->id)}}" onsubmit="confirmDelete(event);" method="POST">
                                            @csrf
                                            @method('DELETE')
